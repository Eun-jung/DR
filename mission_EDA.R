...
unique(mission_dt$missionID) #[1] 138 144 156 159 162 166 167 171
...
mission_result_list = list()


##---------

target_missionID = 138
...
target_raw = data_15min[siteID %in% target_siteID & day >= "2016-06-20" & day <= "2016-07-25"]
...
mission_result_list$reductionRate <- 1 - result_dt$load_mission/result_dt$load_CBL

#add each mission result to mission_result_list 
mission_result_list = append(mission_result_list, setNames(list(mission_result_list),target_missionID))
